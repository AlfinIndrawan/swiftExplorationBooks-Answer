...
The parameter in `print` doesn't have an argument label. To declare a parameter without an argument label, you use the underscore `_` where the argument label would go. In Swift, the underscore means "I don't care about this item because I'm not going to use it."
...
[Previous](@previous)  |  page 13 of 18  |  [Next: Wrapping Up](@next)
 */
