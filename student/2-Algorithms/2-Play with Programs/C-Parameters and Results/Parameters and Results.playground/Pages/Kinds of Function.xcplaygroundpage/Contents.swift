 ...
 **❌ Parameters, ❌ Return value**\
 ...
 Imagine you ask an artist to create a painting for you. If you use a function like `paintAndHangPicture()`, the artist will create whatever they want, then permanently hang the finished piece on whichever wall they like, maybe even in another city.
 ...
 **✅ Parameters, ❌ Return value**\
 ...
 This kind of function does work that changes depending on the arguments, but don't give anything back.
