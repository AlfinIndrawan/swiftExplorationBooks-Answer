...
Defining algorithms is a large part of programming. There are complex mathematical algorithms that do things like compress video so it can be sent efficiently over the internet. There are algorithms that don’t involve mathematics at all, like an algorithm to check if an app user has any new messages and to present a notification if they do. And, of course, there are algorithms for getting software robots to dance.
 Next, get an overview of what you’ve learned.
 
[Previous](@previous)  |  page 8 of 13  |  [Next: Wrapping Up](@next)
 */
//abstraction is a process to divide task into smaller task
//procedural abstraction is By breaking a problem into pieces, you can write functions to solve each piece independently. Once you know all the functions work, you can combine them to solve the bigger problem.
