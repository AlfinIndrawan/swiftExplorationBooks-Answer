...
## Wrapping Up
 ...
 You’ve now seen how functions can be used to group code together so that a complicated task can be performed with a single line of code, even if that line relies on many lines written somewhere else.
