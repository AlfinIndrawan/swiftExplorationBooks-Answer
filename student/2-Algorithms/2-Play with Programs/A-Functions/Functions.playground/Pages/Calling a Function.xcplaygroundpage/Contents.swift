...
## Calling a Function
 ...
 You’ve already taken advantage of abstraction and functions when you used `print()` to print “Hello, world!” to the console. In Swift, `print()` is a function. When you use it, you are _calling_ the function:
 */
print("Hello, world!")
print(360)
/*:
...
In this case, you’re calling a function that someone else has already created. You don’t need to know every detail about how `print()` works in order to call it.
 ...
 Reusability is a large part of what makes functions so powerful. They provide a way to combine detailed steps into a definition that can be used again and again.
