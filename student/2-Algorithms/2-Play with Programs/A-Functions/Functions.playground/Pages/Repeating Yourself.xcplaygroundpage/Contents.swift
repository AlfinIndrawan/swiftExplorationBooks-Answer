...
## Repeating Yourself
 ...
 You’ve also learned how to print to the console. The following code will print a nursery rhyme. Open the console to read it.
 */
...
- Repeating themselves
 ...
 Writing the same code more than once gives you more things to write, more things to understand, and more things to fix.

 How many of the lines of code above are repeated? How can you fix this? Find out on the next page.
 
[Previous](@previous)  |  page 3 of 12  |  [Next: A Single Piece of Work](@next)
 */
