//: ## Strings
//: Look at any app and somewhere in that app you will see text. Text is everywhere, messaging apps, news readers, social media app—even a camera app might use text for some of its buttons and controls.  pagesIn computer science, text values are almost always called _strings_.
//:
