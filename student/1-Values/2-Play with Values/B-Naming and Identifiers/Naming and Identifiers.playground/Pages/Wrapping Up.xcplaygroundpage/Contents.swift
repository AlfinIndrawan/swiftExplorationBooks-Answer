...
- How to declare a constant using `let` and how to assign a value to the constant.

### Exercises
When you learn something new, it can take some practice to get the hang of it.

At the end of each playground in this course, keep an eye out for exercises where you can practice what you’ve learned.
