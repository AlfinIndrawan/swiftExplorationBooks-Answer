...
You may be starting to see a pattern. A large part of programming is making up things, giving them names, and then calling those things by name to use them.
 ...
 There's a second way to associate a value with a name in Swift. These values are called _variables_. With a variable, you can update the value over time as your program runs. The value associated with the name can change, or vary, over time.
