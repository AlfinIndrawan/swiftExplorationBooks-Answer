...
public class ShapeScene: SKScene, SKPhysicsContactDelegate, SKSceneDelegate {
     ...
     */
    public var onShapeTapped: (Shape) -> Void = { _ in }
     ...
     */
    public var onShapeMoving: (Shape) -> Void = { _ in }
    ...
    /**
     ...
     ```
     */
    public var onShapeMoved: (Shape) -> Void = { _ in }
     ...
     */
    public var onBackgroundTapped: (Point) -> Void = { _ in }
     ...
     */
    public var onShapeCollision: (Shape, Shape) -> Void = { _, _ in }
        
    public var onShapeExited: (Shape) -> Void = { _ in }
    ...
    */
    ...
    #if os(iOS)
    public func presentAlert(text: String, completion: @escaping () -> Void) {
