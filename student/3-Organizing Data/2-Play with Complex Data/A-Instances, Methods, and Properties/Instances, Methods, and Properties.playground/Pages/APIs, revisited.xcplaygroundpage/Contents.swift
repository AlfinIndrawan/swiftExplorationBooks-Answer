...
## APIs, Revisited
 ...
 If you can sort-of-remember the name of a method or property, you can just start typing and Xcode will offer you autocompletion suggestions. Programmers use the autocompletion pop-up menu all the time. Here you can see the autocompletion suggestions for "`.has`" when used on a `String` instance:
